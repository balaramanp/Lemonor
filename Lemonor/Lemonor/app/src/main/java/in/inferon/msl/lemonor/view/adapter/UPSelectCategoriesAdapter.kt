...
import `in`.inferon.msl.lemonor.view.activity.UpdateProductActivity
...
class UPSelectCategoriesAdapter(
    private val context: Context,
    private val list: MutableList<String>,
    private val updateProductActivity: UpdateProductActivity
) : RecyclerView.Adapter<UPSelectCategoriesAdapter.ViewHolder>() {
...
//            loadData(list[position], position)
            updateProductActivity.receiveClickListener(list[position])
        }
    }
