...
import kotlinx.android.synthetic.main.cnf_preferred_supplier_adapter.view.*

class CNFPreferredSupplierAdapter(
    private val context: Context,
    private val preferredSupplierList: MutableList<SuppliersForCustomer>
) : RecyclerView.Adapter<CNFPreferredSupplierAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.cnf_preferred_supplier_adapter, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val imgUrl = Constants.SHOP_IMG_BASE_URL + preferredSupplierList[position].user_id
